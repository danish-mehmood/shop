...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters( 'woocommerce_reset_password_message', esc_html__( 'Create a secure ShopandShout password', 'woocommerce' ) ); ?></p><?php // @codingStandardsIgnoreLine ?>
