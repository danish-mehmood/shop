...
if (!empty($fbPages)) {
  ...
  try {
      $graphResponsePages = $fb->get(
        // '/' . $facebook_user_page . '?fields=about,access_token,birthday,category,category_list,current_location,description,emails,engagement,fan_count,general_info,hours,id,name,username,new_like_count,personal_info,personal_interests,preferred_audience,price_range,payment_options,phone,overall_star_rating,location,link,products,website'
        '/' . $fb_query_page . '?fields=about,birthday,category,category_list,current_location,description,emails,fan_count,general_info,hours,id,location,link,members,name,new_like_count,overall_star_rating,payment_options,personal_info,personal_interests,price_range,phone,products,rating_count,username,website'
      );
